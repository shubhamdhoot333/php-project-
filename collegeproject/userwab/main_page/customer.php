				...
				$conn=mysqli_connect($server,$user,$pass,$dbname);
					if(!$conn)
						...
						if(isset($_POST['submit']))
						{
							...
							$result = "select * from problem where email='$Email'";
							...
							$query="INSERT INTO problem(data,email) 
									VALUES('$text','$Email')"; 
...
<!--breadcrumb-->			
						<div aria-label="breadcrumb">
							...
							<div class="container">
							<font face="segoe script" size="5px" ><center>Enter your Problem here</center></font>	
							<form method="post" action="customer.php" >
								
								 <textarea class="form-control" aria-label="With textarea" name="text" ></textarea>
									<font color="red">	<center><p>*255 character limit<p>
																<p>*give your email and phone number </p>	
														</center></font>
										<br><br>
								<center>		
