		...
		<div class="container" style="background-color:#f67280">
			...
			<!--4 row-->						
						...
						<div class="row">
							<div class="col-lg-3"></div>
							<div class="col-lg-3">
							<font face="segoe script"><a href="" class="btn btn-md btn-block btn-primary">Forgot password</a></div>
								<br><br><br>
							<div class="col-lg-3">
							<a href="register.php" class="btn  btn-md btn-block btn-primary">Create account</a></font>
							</div>
							<div class="col-lg-3"></div>
						</div>
				</fieldset>
